...
from django_deovi import __version__ as django_deovi_version


# -- Project information -----------------------------------------------------

now = datetime.date.today()
project = 'django-deovi'
copyright = "2022-{}, David Thenon".format(now.year)
author = 'David Thenon'

# The short X.Y version
version = django_deovi_version
# The full version, including alpha/beta/rc tags
release = django_deovi_version
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/sveetch/django-deovi/",
